 ...
 * MQTT 動態主題資料解析策略
 */
export declare class MqttDynamicTopicProducerStrategy<S = any> implements Strategy<S, MqttDynamicTopicMessage> {
    private _topic;
    /**
     * @param _topic 要訂閱的主題
     */
     ...
     * @return 回傳解析後的資料
     */
    resolve(source: S): Promise<MqttDynamicTopicMessage>;
}
